...
public class handmatig extends javax.swing.JFrame {
    ...
    public String manual_output;           /* deze values worden doorgestuurd naar de RP6 */
    public String ing_snelheid;            /* ingestelde snelheid met fader */  
        ...
        if(evt.getKeyCode()==KeyEvent.VK_UP){
            if(vooruit == 0){
                ...
                if(jRadioButton1.isSelected()){
                    ...
                    int snelheid = jSlider1.getValue();
                    String st_snelheid = Integer.toString(snelheid);
                    ing_snelheid = st_snelheid;
                    
                    int links = jSlider1.getValue();
                    String st_links = Integer.toString(links);
                    motor_links = st_links;
                    System.out.println("      Motor links:  " + motor_links + " = " + motor_links);

                    int rechts = jSlider1.getValue();
                    String st_rechts = Integer.toString(rechts);
                    motor_rechts = st_rechts;
